...
∙ The scope of Secret Infrastructure is to ensure smooth operations of Secret Network public infrastructure (node runner stability, community api, quicksync, and other vital network public network infrastructure).
...
∙ Conduct research on tendermint modifications, api performance enhancements, ect.

Work and Research Examples

1. Testing and documenting different approaching to infrastructure architecture and deployment.
2. Node security best practices documented and fleshed out.
3. Node and infrastructure monitoring and best practices documented.
4. Maintaining other public good / vital network infrastructure such as but potentially not limited to maintaining the community explorer secretnodes.com
...
@moonstash, @mohammedpatla, @dylanschultzie
